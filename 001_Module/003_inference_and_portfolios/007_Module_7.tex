...
\label{sec:The Central Limit Theorem, Confidence Intervals, and Sampling}
\begin{center}
\begin{tabular}{p{0.06\linewidth} | p{0.88\linewidth}}
	a & explain the central limit theorem and the application of confidence intervals and sampling methodologies \\
\end{tabular}
...
\subsection{The Central Limit Theorem (CLT)}
	\label{subsec:The Central Limit Theorem (CLT)}
...
\subsection{Sampling Methodologies}
	\label{subsec:Sampling Methodologies}
...
\label{sec:Hypothesis Testing and Parametric Testing}
\begin{center}
\begin{tabular}{p{0.06\linewidth} | p{0.88\linewidth}}
	b & explain hypothesis testing and its components, including statistical significance, Type I and Type II errors, and the power of a test; construct appropriate hypothesis tests; and interpret the results \\
\end{tabular}
...
\subsection{The Hypothesis Testing Process}
	\label{subsec:The Hypothesis Testing Process}
...
\subsection{Type I and Type II Errors}
	\label{subsec:Type I and Type II Errors}
...
\subsection{Parametric Tests for a Single Variable}
	\label{subsec:Parametric Tests for a Single Variable}
...
\subsection{Parametric Tests for Multiple Variables}
	\label{subsec:Parametric Tests for Multiple Variables}
...
\subsection{P-Value and P-Hacking}
	\label{subsec:P-Value and P-Hacking}
...
\subsection{Practical Implementation (Excel and Google Sheets)}
	\label{subsec:Practical Implementation (Excel and Google Sheets)}
...
\label{sec:Non-Parametric Tests}
\begin{center}
\begin{tabular}{p{0.06\linewidth} | p{0.88\linewidth}}
	c & compare and contrast parametric and non-parametric tests, describe situations in which each is the more appropriate type of test, construct appropriate hypothesis tests, and interpret the results \\
\end{tabular}
...
\subsection{Comparison of Parametric and Non-Parametric Tests}
	\label{subsec:Comparison of Parametric and Non-Parametric Tests}
\begin{itemize}
...
\subsection{Non-Parametric Test for Correlation (Spearman Rank Correlation)}
	\label{subsec:Non-Parametric Test for Correlation (Spearman Rank Correlation)}
...
\subsection{Chi-Square Test of Independence}
	\label{subsec:Chi-Square Test of Independence}
...
% \label{sec:Practice_Problems_Module_7}
% \textcolor{blue}{\textit{Các bài tập ôn tập kèm Lời giải của Module 7 đã được chuyển về Chương 14 (Bài tập ôn tập và Lời giải) ở cuối bản PDF để tiện tra cứu tập trung. Xem bài tập và lời giải tại trang \pageref{sec:app_Problems_M7}.}}
