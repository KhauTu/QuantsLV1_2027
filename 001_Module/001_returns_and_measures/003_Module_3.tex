...
\textcolor{blue}{
	\textit{Chào các bạn! Khi đánh giá hiệu quả đầu tư, chúng ta không chỉ quan tâm đến tỷ suất sinh lời của bản thân tài sản mà còn phải xem xét tác động của dòng tiền ra/vào (contribution/withdrawal). Trong phần này, chúng ta sẽ học cách phân biệt hai loại tỷ suất sinh lời cốt lõi: Suất sinh lời theo thời gian (Time-Weighted Return - TWR) và Suất sinh lời theo dòng tiền (Money-Weighted Return - MWR). Hiểu rõ hai khái niệm này là chìa khóa để đánh giá chính xác hiệu quả quản lý quỹ lẫn hiệu quả đầu tư thực tế của cá nhân bạn.}}
...
\textcolor{blue}{
	\textit{Lưu ý về quy ước dấu dòng tiền từ góc nhìn của nhà đầu tư:
	- Số tiền đầu tư ban đầu ($\text{CF}_0$) và các khoản đóng góp thêm vốn sau đó mang dấu âm (--) vì đây là dòng tiền đi ra khỏi ví của nhà đầu tư.
	- Các khoản cổ tức nhận bằng tiền mặt, các khoản rút vốn hoặc giá trị còn lại của danh mục tại thời điểm cuối kỳ mang dấu dương (+) vì đây là dòng tiền đi vào ví của nhà đầu tư.
	- Việc tính toán MWR bản chất là đi tìm nghiệm của phương trình bậc cao nên không có công thức đại số trực tiếp, chúng ta sẽ phải sử dụng máy tính tài chính hoặc Excel để giải phương trình này.}}
...
\textcolor{blue}{
	\textit{Phân tích dòng tiền của Albright Fund (từ góc độ nhà đầu tư):
	- Tại $t=0$: Dòng tiền ra $\text{CF}_0 = -100$ triệu EUR.
	- Tại $t=1$: Tổng dòng tiền ròng là $\text{CF}_1 = -30$ triệu EUR (gồm $-20$ triệu đóng góp thêm và $-10$ triệu tái đầu tư lãi vốn. Tiền cổ tức $2$ triệu nhận và tái đầu tư ngay nên triệt tiêu).
	- Tại $t=2$: Dòng tiền ròng $\text{CF}_2 = 0$ do cổ tức được tái đầu tư ngay.
	- Tại $t=3$: Dòng tiền vào $\text{CF}_3 = +140$ triệu EUR (gồm giá trị cuối kỳ 137 triệu và 3 triệu cổ tức rút ra).}}
...
\textcolor{blue}{
	\textit{So sánh: $r_{\text{TW}} = 19.26\%$ và $r_{\text{MW}} = 8.35\%$. MWR thấp hơn nhiều vì quỹ nhận thêm EUR 20 triệu ngay trước khi tỷ suất sinh lời của quỹ bị âm ($-3.70\%$). Lượng vốn lớn này chịu lỗ làm giảm mạnh MWR của cả quỹ, trong khi TWR phản ánh khách quan hiệu quả đầu tư thuần túy mà không bị ảnh hưởng bởi dòng tiền này.}}
\end{tcolorbox}
...
\textcolor{blue}{
	\textit{Chỉ số thị trường (Market Index) là một công cụ cực kỳ quan trọng làm thước đo chuẩn (Benchmark) để so sánh hiệu quả đầu tư, đồng thời làm cơ sở để xây dựng các quỹ đầu tư thụ động (Passive/ETF). Khi thiết kế một chỉ số, hai lựa chọn kỹ thuật quan trọng nhất là: (1) Chỉ số tính theo giá trị tăng trưởng giá thuần (Price Return) hay có tái đầu tư cổ tức (Total Return), và (2) Phương pháp phân bổ tỷ trọng (Weighting Scheme) cho các cổ phiếu thành phần. Hãy cùng phân tích các phương pháp này ở phần dưới đây.}}
...
\textcolor{blue}{
	\textit{Hãy thảo luận về cơ chế tự điều chỉnh (Self-Rebalancing) của chỉ số Market Capitalization:
	- Khi giá cổ phiếu thành phần thay đổi, tỷ trọng của nó trong chỉ số tự động điều chỉnh tương ứng với vốn hóa của nó. Vì vậy, nhà đầu tư mô phỏng chỉ số này không cần phải mua bán cổ phiếu để tái cơ cấu tỷ trọng (tỷ lệ luân chuyển danh mục cực thấp).
	- Tuy nhiên, nhược điểm lớn nhất là chỉ số này bị ảnh hưởng bởi đà tăng giá (momentum bias): cổ phiếu nào tăng giá càng mạnh thì tỷ trọng càng tăng, dẫn đến việc nhà đầu tư thụ động bị ép mua nhiều cổ phiếu được định giá quá cao (bong bóng).}}
...
\textcolor{blue}{
	\textit{Giải thích thêm: Khi cổ phiếu A chia tách, giá giảm cơ học nên Divisor phải giảm từ 1.5 xuống 1.25 để giữ chỉ số không bị sụt giảm giả tạo. Điều này gián tiếp làm tăng tỷ trọng ảnh hưởng của 4 cổ phiếu còn lại trong chỉ số.}}
\end{tcolorbox}
